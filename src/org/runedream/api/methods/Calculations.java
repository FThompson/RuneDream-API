...
public class Calculations {
	...
	/**
	 * Gets the nearest point to a given point of points with a given color within a given threshold.
	 * @param point The point to check others' distances to.
	 * @param color The color to identify other points with.
	 * @param threshold The threshold to match point colors within.
	 * @return The nearest point of given color to the given point.
	 */
	public static Point getNearestPoint(final Point point, final Color color, final double threshold) {
		final List<Point> pts = Game.getPointsWithColor(color, threshold);
